...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-neutral-850 transition-colors hover:bg-neutral-900/60 data-[state=selected]:bg-neutral-900',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-9 px-3 text-left align-middle font-medium text-neutral-400 [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
